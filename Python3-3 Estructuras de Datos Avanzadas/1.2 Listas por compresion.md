...
### Ejemplo de una forma de concisa y elegante de creación por compransión

```Python
# Comprensión de lista: crear una nueva lista con los cuadrados de los números
numeros = [1, 2, 3, 4]
cuadrados = [numero ** 2 for numero in numeros]
print(cuadrados)  # Output: [1, 4, 9, 16]

# Comprensión de diccionario: crear un nuevo diccionario con clave: valor*2
mi_diccionario = {"a": 1, "b": 2, "c": 3}
nuevo_diccionario = {clave: valor * 2 for clave, valor in mi_diccionario.items()}
print(nuevo_diccionario)  # Output: {'a': 2, 'b': 4, 'c': 6}

# Comprensión de conjunto: crear un nuevo conjunto con las longitudes de las palabras
palabras = ["hola", "mundo", "python"]
longitudes = {len(palabra) for palabra in palabras}
print(longitudes)  # Output: {4, 5, 6} (los conjuntos no tienen orden y eliminan duplicados)
```